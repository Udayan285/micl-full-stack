...
<div class="container mt-2 mb-2">
  ...
  <form action="{{ route('dashboard.bitumenUpdate',$bitumenEdit->id) }}" method="POST" id="survey-form" enctype="multipart/form-data">
    ...
    <li>
        ...
        <textarea id="textArea" name="storage_tank" rows="4" cols="50">{{ $bitumenEdit ? $bitumenEdit->storage_tank : '' }}</textarea>
     </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="service_tank" rows="4" cols="50">{{ $bitumenEdit ? $bitumenEdit->service_tank : '' }}</textarea>
    </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="product_turnover" rows="4" cols="50">{{ $bitumenEdit ? $bitumenEdit->product_turnover : '' }}</textarea>
    </li>
