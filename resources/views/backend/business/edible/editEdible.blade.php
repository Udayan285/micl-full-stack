...
<div class="container mt-2 mb-2">
  ...
  <h3 id="description">Edit Edible Oil Filling (Bottle) Plant</h3>
  <form action="{{ route('dashboard.updateEdible',$edibleEdit->id) }}" method="POST" enctype="multipart/form-data" id="survey-form">
    @csrf
    @method("PUT")
    <ul class="flex-outer">
    ...
    @enderror 
     <li>
      ...
      <textarea id="textArea" name="plant_manufacturer" rows="4" cols="50">{{ $edibleEdit ? $edibleEdit->plant_manufacturer : '' }}</textarea>
     </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="product" rows="4" cols="50">{{ $edibleEdit ? $edibleEdit->product : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="utility_requirement" rows="4" cols="50">{{ $edibleEdit ? $edibleEdit->utility_requirement : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="manpower_requirement" rows="4" cols="50">{{ $edibleEdit ? $edibleEdit->manpower_requirement : '' }}</textarea>
    </li>
   ...
   <li>
    ...
    <li>
     ...
     <div>
        <div class="row">
            @if($edibleEdit && $edibleEdit->images)
                @php
                    $images = explode('|', $edibleEdit->images); // Split string into an array using the pipe as a delimiter
                @endphp
