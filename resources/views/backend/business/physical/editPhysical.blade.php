...
<div class="container mt-2 mb-2">
  <div style="display: flex; justify-content: flex-end;">
    <a href="{{ route('dashboard.previewPhysical') }}"><button class="btn btn-sm btn-primary mt-3">Back</button></a>
  </div>
  <h3 id="description">Edit Physical Refinery Unit </h3>
  <form action="{{ route('dashboard.updatePhysical',$physicalEdit->id) }}" method="POST" enctype="multipart/form-data" id="survey-form">
    @csrf
    @method('PUT')
    <ul class="flex-outer">
    ...
    <li>
        ...
        <textarea id="textArea" name="year_establishment" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->year_establishment : '' }}</textarea>
     </li>
    ...
    @enderror
     <li>
      ...
      <textarea id="textArea" name="plant_manufacturer" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->plant_manufacturer : '' }}</textarea>
     </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="country_origin" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->country_origin : '' }}</textarea>
    </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="prime_raw_material" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->prime_raw_material : '' }}</textarea>
    </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="product" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->product : '' }}</textarea>
    </li>
    ...
    <li>
      ...
      <textarea id="textArea" name="pack_size" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->pack_size : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="existing_capacity" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->existing_capacity : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="utility_requirement" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->utility_requirement : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="manpower_requirement" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->manpower_requirement : '' }}</textarea>
    </li>
    ...
    <li>
        ...
        <textarea id="textArea" name="present_status" rows="4" cols="50">{{ $physicalEdit ? $physicalEdit->present_status : '' }}</textarea>
    </li>
    ...
    <li>
     ...
     <li>
      ...
      <div>
        ...
        <div class="row">
            @if($physicalEdit && $physicalEdit->images)
                @php
                    $images = explode('|', $physicalEdit->images); // Split string into an array using the pipe as a delimiter
                @endphp
