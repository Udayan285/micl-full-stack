...
<div class="container mt-2 mb-2">
  ...
  <h3 id="description">Super Oil Refinery & Dry fractionation Unit</h3>
  <form action="{{ route('dashboard.storeSuper') }}" method="POST" enctype="multipart/form-data" id="survey-form">
    @csrf
    <ul class="flex-outer">
