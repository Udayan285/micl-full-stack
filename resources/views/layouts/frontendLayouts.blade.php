...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <p class="mb-2" style="text-align:left;"><b style="color: #ffc706;">Corporate Office :</b> {!! $foot->corporate_office !!}</p>
                        <p class="mb-2 align-left-item"><b>MICL Sales Office :</b> {!! $foot->sales_office !!}</p>
                        <p class="mb-2" style="text-align:left;"><b style="color: #ffc706;">Factory :</b> {!! $foot->factory !!}</p>
                    </div>
                    @empty
                    <div class="col-lg-4 col-md-6">
                        <h3 class="text-white mb-4">Get In Touch</h3>
                        <p class="mb-2"><b style="color: #ffc706;">Corporate Office :</b> Habib’s, (Level-4), 1574/A, East Nasirabad, Bayezid Bostami Road, Opposite side of Nasirabad Housing Society (Road No-03), Panchlaish, Chattogram - 4000, Bangladesh.</p>
                        <p class="mb-2" style="text-align: left !important;"><b style="color: #ffc706;">MICL Sales Office :</b>269,Khatungonj,Chattogram.</p>
        ...
        <!-- Footer End -->
        <div class="container-fluid" style="text-align: center; color:black; margin-top:5px;marging-bottom:5px;">
            <span>&#169; All right reserved by miclbd.com</span>
        </div>
